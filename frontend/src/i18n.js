...
const translations = {
  en: {
    ...
    batchPageTitle: "📦 Batch Analysis — Upload & Multi-Ticker",
    batchHelpShow: "▸ How to use",
    batchHelpHide: "▾ Hide help",
    batchAcceptedFormats: "Accepted formats:",
    batchTickerHelp: "Tickers: AAPL, NVDA, MSFT, GOOGL, MC.PA (one per line or comma-separated)",
    batchIsinHelp: "ISINs: US0378331005, FR0000121014 (converted to tickers when known)",
    batchSteps: "Steps:",
    batchStepUpload: "Upload a .txt or .csv file, or paste tickers below",
    batchStepSelect: "Select or deselect tickers from the parsed list",
    batchStepRun: "Run the analysis — each ticker can take several minutes",
    batchStepDownload: "Review the results and download the ZIP package",
    batchDropPrompt: "Drag and drop a .txt or .csv file here, or click to upload",
    batchDropHint: "One ticker per line or comma-separated; ISINs are also accepted",
    batchParse: "Parse tickers",
    batchSelectAll: "Select all",
    batchDeselectAll: "Deselect all",
    batchSelectedSummary: "{total} ticker(s) — {selected} selected",
    batchNoTickers: "No tickers found",
    batchRun: "Run analysis on {count} ticker(s)",
    batchRunning: "Running analysis…",
    batchUploadFailed: "Upload failed",
    batchError: "Batch error",
    batchTimeout: "The analysis is taking longer than expected. Please try again later.",
    batchAcceptedError: "Accepted formats: .txt and .csv",
    batchProgress: "Running analysis… ({completed}/{total})",
    batchAnalyzed: "{completed}/{total} tickers analyzed",
    ...
    analysisDuration: "Results usually appear in 1-2 minutes. The verified PDF continues building in the background (4-7 min).",
    ...
    aboutRules: [
      ["BUY", "Score ≥ 28/40 — strong fundamentals across most criteria"],
      ["HOLD", "Score 18-27 — mixed fundamentals; monitor before adding"],
  ...
  jp: {  // canonical
    ...
    batchAnalysis: "📦 バッチ分析 (TXT/CSV + ZIP)",
    ...
    batchPageTitle: "📦 バッチ分析 — アップロード・複数銘柄",
    batchHelpShow: "▸ 使い方",
    batchHelpHide: "▾ 使い方を閉じる",
    batchAcceptedFormats: "対応形式:",
    batchTickerHelp: "ティッカー: AAPL、NVDA、MSFT、GOOGL、MC.PA（1行ずつ、またはカンマ区切り）",
    batchIsinHelp: "ISIN: US0378331005、FR0000121014（対応している場合はティッカーに変換）",
    batchSteps: "手順:",
    batchStepUpload: ".txt または .csv ファイルをアップロードするか、下にティッカーを貼り付けます",
    batchStepSelect: "読み込んだ一覧から分析する銘柄を選択します",
    batchStepRun: "分析を開始します。1銘柄に数分かかる場合があります",
    batchStepDownload: "結果を確認し、ZIPパッケージをダウンロードします",
    batchDropPrompt: ".txt または .csv ファイルをここにドロップするか、クリックして選択",
    batchDropHint: "1行に1銘柄、またはカンマ区切り。ISINにも対応しています",
    batchParse: "ティッカーを読み込む",
    batchSelectAll: "すべて選択",
    batchDeselectAll: "すべて解除",
    batchSelectedSummary: "{total}銘柄 — {selected}件選択中",
    batchNoTickers: "ティッカーが見つかりません",
    batchRun: "{count}銘柄を分析",
    batchRunning: "分析を実行中…",
    batchUploadFailed: "アップロードに失敗しました",
    batchError: "バッチ分析エラー",
    batchTimeout: "分析に通常より時間がかかっています。しばらくしてから再度お試しください。",
    batchAcceptedError: "対応形式: .txt、.csv",
    batchProgress: "分析を実行中…（{completed}/{total}）",
    batchAnalyzed: "{completed}/{total}銘柄の分析が完了",
    batchDownloadZip: "ZIPをダウンロード",
    batchScore: "スコア",
    batchErrors: "エラー",
    uploadCSV: "CSVアップロード",
    ...
    analysisDuration: "結果は通常1〜2分で表示されます。検証済みPDFはバックグラウンドで生成を続けます（4〜7分）。",
    ...
    aboutRules: [
      ["買い", "スコア ≥ 28/40 — ほとんどの基準で強固なファンダメンタルズ"],
      ["ホールド", "スコア 18-27 — ファンダメンタルズは混在、追加購入前に要監視"],
