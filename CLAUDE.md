# CLAUDE.md — Stock Analysis Pipeline Rules
...
- **Règle d'or de lecture :** Utilise `codegraph_explore` pour lire le code de plusieurs symboles liés d'un coup, plutôt d'enchaîner des `read_file` répétés qui saturent la fenêtre de contexte.
