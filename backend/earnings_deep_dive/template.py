...
EARNINGS_TEMPLATE: tuple[ReportSectionTemplate, ...] = (
    ...
    ReportSectionTemplate(
        ...
        table_rows=("Gross profit", "Gross margin", "OpEx", "Operating income", "Operating margin", "Net income"),
    ...
    ReportSectionTemplate(
        ...
        table_columns=("Segment", "Revenue", "YoY", "Driver", "Source"),
    ...
    ReportSectionTemplate(
        ...
        table_rows=("Revenue guidance", "Margin guidance", "EPS guidance"),
    ...
    ReportSectionTemplate(
        ...
        table_columns=("Dimension", "Assessment", "Evidence", "Risk", "Source"),
...
JAPANESE_EARNINGS_TEMPLATE: tuple[ReportSectionTemplate, ...] = (
    ...
    ReportSectionTemplate(
        ...
        table_rows=("粗利益", "粗利益率", "営業費用", "営業利益", "営業利益率", "純利益"),
    ...
    ReportSectionTemplate(
        ...
        table_columns=("セグメント", "売上高", "前年同期比", "ドライバー", "出所"),
    ...
    ReportSectionTemplate(
        ...
        table_rows=("売上高ガイダンス", "利益率ガイダンス", "EPSガイダンス"),
