...
- **Tests**: pytest 90/90 (backend), node 68/68 (frontend chartUtils)
...
| 2026-05-25 | V2.5-T2 | Peer Batch Layer: get_peer_benchmark_snapshot() with cache + partial failure, 9 tests |
...
- **When modifying backend routes**: run `pytest backend/tests/` (90 tests)
...
- Tests: 90 backend + 68 frontend = 0 failures
